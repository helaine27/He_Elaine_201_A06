...
co_annual <- apply(co_temp[,3:13], 1, median)

#print statement
sprintf("The maximum median annual temperature of %f occurred in %d and the minimum median annual temperature of %f occurred in %d.", max(co_annual), co_temp$year[which.max(co_annual)], min(co_annual), co_temp$year[which.min(co_annual)])
